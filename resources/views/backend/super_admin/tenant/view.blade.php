						...
						<div class="table-responsive">
							<table class="table table-bordered">
								...
								<tr>
									...
									<td>{{ $tenant->package->user_limit }}</td>
								</tr>
								<tr>
									<td>{{ _lang('Member Limit') }}</td>
									<td>{{ $tenant->package->member_limit }}</td>
								</tr>
								<tr>
									<td>{{ _lang('Branch Limit') }}</td>
									<td>{{ $tenant->package->branch_limit }}</td>
								</tr>
								<tr>
									<td>{{ _lang('Account Type Limit') }}</td>
									<td>{{ $tenant->package->account_type_limit }}</td>
								</tr>
								<tr>
									<td>{{ _lang('Account Limit') }}</td>
									<td>{{ $tenant->package->account_limit }}</td>
								</tr>
								<tr>
