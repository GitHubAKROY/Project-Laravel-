                ...
                <div class="card-body">
					...
					<form method="POST" class="form-signin" action="{{ $postUrl }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email', request()->email) }}" placeholder="{{ _lang('Email') }}" required autofocus>
