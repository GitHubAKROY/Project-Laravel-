    ...
    Route::group(['middleware' => $initialMiddleware], function () {
        ...
        Route::name('admin.')->prefix('admin')->middleware(['superadmin'])->group(function () {
            ...
            Route::group(['middleware' => 'demo'], function () {
                ...
                Route::get('backups/create', [BackupController::class, 'create_backup'])->name('backup.create');
                ...
                Route::get('backups/{file}/download', [BackupController::class, 'download'])->name('backup.download');
        ...
        //Tenant Dashboard
        Route::prefix('{tenant}')
        ->middleware(['tenant', 'tenant.global'])
        ->group(function () {
